<template>
    ...
    <fab-button icon="fa fa-save"></fab-button>
    <img src="https://www.cinepremiere.com.mx/wp-content/uploads/2022/07/Saint-Seiya-Caballeros-del-Zodiaco-Live-Action-trailer.jpg" alt="entry-picture" class="img-thumbnail">
</template>
